...
assert_eq "paywall-trial-emphasis" "$(rule_slug 44)" "catalog lookup §44 paywall-trial-emphasis"
assert_eq "metadata-pricing-language" "$(rule_slug 45)" "catalog lookup §45 metadata-pricing-language"
