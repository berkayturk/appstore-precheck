...
### Added
- **Kova B v1 — 6 heuristic Pierre deep-review checks** (28 total, up from 22). New Phase 4 items
...
- Phase 4 checklist 22 → **28** across `pierre-deep-review.md`, `SKILL.md`, `methodology.md`, README
  (full guideline-ordered table with † Kova B labels), plugin manifest, and social preview
